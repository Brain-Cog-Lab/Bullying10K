...
class R2Plus1DNet(nn.Module):
    ...
    def __init__(self, layer_sizes,inchannel=3, block_type=SpatioTemporalResBlock):
        super(R2Plus1DNet, self).__init__()

        # first conv, with stride 1x2x2 and kernel size 1x7x7
        self.conv1 = SpatioTemporalConv(inchannel, 64, (1, 7, 7), stride=(1, 2, 2), padding=(0, 3, 3), first_conv=True)
...
class R2Plus1DClassifier(nn.Module):
    ...
    def __init__(self, num_classes, layer_sizes, inchannel=3,block_type=SpatioTemporalResBlock, pretrained=False):
        super(R2Plus1DClassifier, self).__init__()

        self.res2plus1d = R2Plus1DNet(layer_sizes,inchannel, block_type)
